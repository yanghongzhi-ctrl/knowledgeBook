...
DEFAULT_OUTPUT_JSON = ROOT / "output" / "ch10_p2_source_review_packet_2026-06-05.json"
DEFAULT_OUTPUT_MD = ROOT / "output" / "ch10_p2_source_review_packet_2026-06-05.md"
DEFAULT_OUTPUT_CSV = ROOT / "output" / "ch10_p2_source_review_packet_2026-06-05.csv"


def main() -> int:
    parser = argparse.ArgumentParser(description="Build a focused P2 review packet for ch10 Source_Chunks.")
    ...
    decisions = [
        ...
        and item.get("chapter_id") == "ch10"
        and item.get("priority_group") == "P2_ch10_boundary_summary"
    ]
    ...
    payload = {
        ...
        "chapter_id": "ch10",
        "priority_group": "P2_ch10_boundary_summary",
        "purpose": (
            "Focused P2 review packet for ch10 boundary fragments and teaching summaries. "
